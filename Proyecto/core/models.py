...
class Productos(models.Model):
    ...
    descripcion = models.CharField(db_column='Descripcion', max_length=255, db_collation='SQL_Latin1_General_CP1_CI_AS', blank=True, null=True)  # Field name made lowercase.
...
class InventarioView(models.Model):
    producto_id = models.IntegerField(db_column='ProductoID', primary_key=True)
    ...
    class Meta:
        managed = False  # No crear ni modificar la tabla en la base de datos
        db_table = 'InventarioView'